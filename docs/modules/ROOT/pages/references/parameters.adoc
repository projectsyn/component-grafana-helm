...
WARNING: The openshiftIntegration overwrites the data sources in `helm_values.datasources`. Use the top level <<_datasources>> if you want to add datasources additionally to the openshift integration.
